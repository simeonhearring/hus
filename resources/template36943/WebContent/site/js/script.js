...
$(function(){
	...
	if($("#package-search").length||$("#trips-select-form").length)$.include('js/jquery.jqtransform.js')
	...
	$('.banners').append('<em class="banners-hr"></em>').hover(
		function(){$(this).find('.banners-hr').stop().animate({left:0,right:0,top:0,bottom:0}, 100)},
		function(){$(this).find('.banners-hr').stop().animate({left:5,right:5,top:5,bottom:5}, 100)}
	)
})			
